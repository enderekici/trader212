export const HELP: Record<string, string> = {
  ...
  'execution.reEvaluatePositions': 'If enabled, the decision engine periodically re-analyzes open positions for exit signals.',
  ...
  'page.signals': 'Analysis signals generated for each stock, including scores and decisions.',
  ...
  'signals.decision': 'Decision engine output: BUY, SELL, or HOLD, with conviction percentage.',
